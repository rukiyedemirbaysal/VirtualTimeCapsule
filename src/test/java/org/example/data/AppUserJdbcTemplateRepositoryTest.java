...
class AppUserJdbcTemplateRepositoryTest {
    ...
    void shouldFindByUsername() {
        AppUser expected = TestHelper.makeAppUser(1);
    ...
    void shouldAddAppUser() {
        AppUser appUser = new AppUser(0, "test3@app.com", "hashed_pass_3",true, email, List.of("TEST_ROLE_1"));
        AppUser expected = new AppUser(3, "test3@app.com", "hashed_pass_3", true, email, List.of("TEST_ROLE_1"));
