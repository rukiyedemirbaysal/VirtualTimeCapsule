...
class AppUserServiceTest {
    ...
    void shouldAddValidUser() {
        AppUser expected = new AppUser(5, "test1@test.com", "hashed_password", true, email, List.of("USER"));
    ...
    void shouldNotAddDuplicateUsername() {
        AppUser existing = new AppUser(5, "existing@test.com", "password", true, email, List.of("USER"));
